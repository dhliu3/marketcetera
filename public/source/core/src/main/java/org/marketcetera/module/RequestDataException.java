 ...
 * @version $Id: RequestDataException.java 10229 2008-12-09 21:48:48Z klim $
 * @since 1.0.0
 * @see DataEmitter#requestData(DataRequest, DataEmitterSupport)
 */
@ClassVersion("$Id: RequestDataException.java 10229 2008-12-09 21:48:48Z klim $") //$NON-NLS-1$

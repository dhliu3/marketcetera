 ...
 * @version $Id: ReceiveDataException.java 10229 2008-12-09 21:48:48Z klim $
 * @since 1.0.0
 * @see DataReceiver#receiveData(DataFlowID, Object) 
 */
@ClassVersion("$Id: ReceiveDataException.java 10229 2008-12-09 21:48:48Z klim $") //$NON-NLS-1$

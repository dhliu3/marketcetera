...
/**
 * @author toli
 * @version $Id: DBBackedIDFactory.java 10187 2008-12-04 23:48:09Z tlerios $
 */

@ClassVersion("$Id: DBBackedIDFactory.java 10187 2008-12-04 23:48:09Z tlerios $") //$NON-NLS-1$

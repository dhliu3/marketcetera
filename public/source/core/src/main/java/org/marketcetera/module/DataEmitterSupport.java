 ...
 * @version $Id: DataEmitterSupport.java 10280 2009-01-15 21:25:09Z anshul $
 * @since 1.0.0
 * 
 * @see DataEmitter
 */
@ClassVersion("$Id: DataEmitterSupport.java 10280 2009-01-15 21:25:09Z anshul $")  //$NON-NLS-1$

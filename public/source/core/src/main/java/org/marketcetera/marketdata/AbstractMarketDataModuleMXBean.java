 ...
 * @version $Id: AbstractMarketDataModuleMXBean.java 10951 2010-06-30 09:45:27Z colin $
 * @since 1.0.0
 */
@ClassVersion("$Id: AbstractMarketDataModuleMXBean.java 10951 2010-06-30 09:45:27Z colin $") //$NON-NLS-1$
@MXBean(true)

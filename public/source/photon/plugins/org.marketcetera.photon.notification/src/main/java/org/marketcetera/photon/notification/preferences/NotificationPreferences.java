 ...
 * @version $Id: NotificationPreferences.java 9860 2008-10-10 22:00:53Z klim $
 * @since 0.8.0
 */
@ClassVersion("$Id: NotificationPreferences.java 9860 2008-10-10 22:00:53Z klim $")//$NON-NLS-1$

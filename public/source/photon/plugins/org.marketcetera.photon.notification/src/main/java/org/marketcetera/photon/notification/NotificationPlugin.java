 ...
 * @version $Id: NotificationPlugin.java 9860 2008-10-10 22:00:53Z klim $
 * @since 0.8.0
 */
@ClassVersion("$Id: NotificationPlugin.java 9860 2008-10-10 22:00:53Z klim $")//$NON-NLS-1$
public class NotificationPlugin extends AbstractUIPlugin {
	 ...
	 * @since 0.8.0
	 */
	@ClassVersion("$Id: NotificationPlugin.java 9860 2008-10-10 22:00:53Z klim $")

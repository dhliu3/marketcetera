 ...
 * @author gmiller
 * @version $Id: PhotonConsoleAppender.java 10875 2009-11-16 15:39:07Z will $
 * @since 1.0.0
 *
 */
@ClassVersion("$Id: PhotonConsoleAppender.java 10875 2009-11-16 15:39:07Z will $") //$NON-NLS-1$

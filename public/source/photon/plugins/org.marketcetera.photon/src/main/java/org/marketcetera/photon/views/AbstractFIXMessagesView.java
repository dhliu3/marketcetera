 ...
 */
@ClassVersion("$Id: AbstractFIXMessagesView.java 10605 2009-06-19 20:39:47Z will $")
        ...
        extends MessagesViewBase<ReportHolder>
{
     ...
     *
     * @author <a href="mailto:colin@marketcetera.com">Colin DuPlantis</a>
     * @version $Id: AbstractFIXMessagesView.java 10605 2009-06-19 20:39:47Z will $
     * @since 0.7.0
     */
    @ClassVersion("$Id: AbstractFIXMessagesView.java 10605 2009-06-19 20:39:47Z will $")//$NON-NLS-1$

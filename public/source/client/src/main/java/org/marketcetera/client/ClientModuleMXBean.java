 ...
 * @version $Id: ClientModuleMXBean.java 10407 2009-03-10 12:06:21Z tlerios $
 * @since 1.0.0
 */
@MXBean(true)
@DisplayName("Management interface for the Client Module instance")
@ClassVersion("$Id: ClientModuleMXBean.java 10407 2009-03-10 12:06:21Z tlerios $") //$NON-NLS-1$
